...
?>
                        ...
                        <div class="container-fluid px-4">
                            <h1 class="mt-4">Categorie des medicaments</h1>
                        ...
                        ?>
                            ...
                            <ol class="breadcrumb mb-4">
                                ...
                                <li class="breadcrumb-item"><a href="category.php">Categorie des medicaments</a></li>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-header">
                                            <i class="fas fa-user-plus"></i> Ajouter une categorie
                                        </div>
                                        <div class="card-body">
                                            <form method="post">
                        ...
                        <?php
                            ...
                            else if($_GET["action"] == 'edit')
                            {
                                ...
                                <ol class="breadcrumb mb-4">
                                    <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="category.php">Categorie des medicaments</a></li>
                                    <li class="breadcrumb-item active">Modifier la categorie</li>
                                </ol>
                                <div class="row">
                                    <div class="col-md-6">
                                        <?php
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                <i class="fas fa-user-edit"></i>Modifier les details de la categorie
                                            </div>
                                            <div class="card-body">
                                                <form method="post">
                                                    <div class="form-floating mb-3">
                        ...
                        ?>
                            ...
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Categorie des medicaments</li>
                            </ol>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col col-md-6">
                                            <i class="fas fa-table me-1"></i> Categorie des medicaments
                                        </div>
                                        <div class="col col-md-6" align="right">
                                            <a href="category.php?action=add&code=<?php echo $object->convert_data('add'); ?>" class="btn btn-success btn-sm">Ajouter une categorie</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
