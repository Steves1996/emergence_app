...
?>
                        ...
                        <div class="container-fluid px-4">
                            <h1 class="mt-4">Fabriquant du medicament</h1>
                        ...
                        ?>
                            ...
                            <ol class="breadcrumb mb-4">
                                ...
                                <li class="breadcrumb-item"><a href="company.php">Fabriquant du medicament</a></li>
                                <li class="breadcrumb-item active">Ajouter un fabriquant</li>
                            </ol>
                            <div class="row">
                                <div class="col-md-6">
                                    <?php
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-header">
                                            <i class="fas fa-user-plus"></i> Ajouter un fabriquant
                                        </div>
                                        <div class="card-body">
                                            <form method="post">
                                                <div class="form-floating mb-3">
                                                    ...
                                                    <label for="company_name">Nom du fabriquant</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                    ...
                                                    <label for="company_short_name">Nom court</label>
                                                </div>
                                                <div class="mt-4 mb-0">
                        ...
                        <?php
                            ...
                            else if($_GET["action"] == 'edit')
                            {
                                ...
                                <ol class="breadcrumb mb-4">
                                    <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="company.php">Fabriquant du medicament</a></li>
                                    <li class="breadcrumb-item active">Modifier un fabriquant</li>
                                </ol>
                                <div class="row">
                                    <div class="col-md-6">
                                        <?php
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                <i class="fas fa-user-edit"></i> Modifier un fabriquant
                                            </div>
                                            <div class="card-body">
                                                <form method="post">
                                                    <div class="form-floating mb-3">
                        ...
                        ?>
                            ...
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Fabriquant du medicament</li>
                            </ol>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col col-md-6">
                                            <i class="fas fa-table me-1"></i> Fabriquant du medicament
                                        </div>
                                        <div class="col col-md-6" align="right">
                                            <a href="company.php?action=add&code=<?php echo $object->convert_data('add'); ?>" class="btn btn-success btn-sm">Ajouter un fabriquant</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
