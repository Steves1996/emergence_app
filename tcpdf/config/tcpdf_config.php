 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
//define('K_PATH_IMAGES', '../config/emergence_logo.png');
 ...
 * Document author.
 */
define('PDF_AUTHOR', 'emergence');

/**
 * Header title.
 */
define('PDF_HEADER_TITLE', "CM-EMERGENCE");

/**
 * Header description string.
 */
define('PDF_HEADER_STRING', "Centre Medicale et Pharmacie, Douala logbessou, Phone: 691284763/674630409");
/**
