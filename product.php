...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch_medicine_data')
	{
		...
		foreach($result as $row)
		{
			...
			$data['medicine_expired_month']			=	$row["medicine_expired_month"];
			$data['medicine_expired_year']			=	$row["medicine_expired_year"];
			...
			$data['medicine_purchase_price_per_unit']=	$row["medicine_purchase_price_per_unit"];
		}
