...
?>
                        ...
                        <div class="container-fluid px-4">
                            <h1 class="mt-4">Position sur comptoir</h1>
                        ...
                        ?>
                            ...
                            <ol class="breadcrumb mb-4">
                                ...
                                <li class="breadcrumb-item"><a href="category.php">Position sur comptoir</a></li>
                                <li class="breadcrumb-item active">Ajouter un rang</li>
                            </ol>
                            <div class="row">
                                <div class="col-md-6">
                                    <?php
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-header">
                                            <i class="fas fa-user-plus"></i> Ajouter un rang
                                        </div>
                                        <div class="card-body">
                                            <form method="post">
                                                <div class="form-floating mb-3">
                                                    ...
                                                    <label for="location_rack_name">Nom du rang</label>
                                                </div>
                                                <div class="mt-4 mb-0">
                        ...
                        <?php
                            ...
                            else if($_GET["action"] == 'edit')
                            {
                                ...
                                <ol class="breadcrumb mb-4">
                                    <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="location_rack.php">Position sur comptoir</a></li>
                                    <li class="breadcrumb-item active">Modifier un rang</li>
                                </ol>
                                <div class="row">
                                    <div class="col-md-6">
                                        <?php
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                <i class="fas fa-user-edit"></i> Modifier un rang
                                            </div>
                                            <div class="card-body">
                                                <form method="post">
                                                    <div class="form-floating mb-3">
                        ...
                        ?>
                            ...
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Position sur comptoir</li>
                            </ol>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col col-md-6">
                                            <i class="fas fa-table me-1"></i> Position sur comptoir
                                        </div>
                                        <div class="col col-md-6" align="right">
                                            <a href="location_rack.php?action=add&code=<?php echo $object->convert_data('add'); ?>" class="btn btn-success btn-sm">Ajouter un rang</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
