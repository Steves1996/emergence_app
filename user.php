                                        ...
                                        <div class="card-body">
                                            <form method="post">
                                                <div class="form-floating mb-3">
                                                    ...
                                                    <label for="user_name">Nom & prenom</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col col-md-6" align="right">
                                            <a href="user.php?action=add&code=<?php echo $object->convert_data('add'); ?>" class="btn btn-success btn-sm">Ajouter un utilisateur</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
