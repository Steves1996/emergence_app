...
?>
                        ...
                        <div class="container-fluid px-4">
                            <h1 class="mt-4">Gestion des fournisseur</h1>
                        ...
                        ?>
                            ...
                            <ol class="breadcrumb mb-4">
                                ...
                                <li class="breadcrumb-item"><a href="supplier.php">Gestion des fournisseur</a></li>
                                        ...
                                        <div class="card-body">
                                            <form method="post">
                                                <div class="form-floating mb-3">
                                                    ...
                                                    <label for="supplier_name">Nom & prenom</label>
                                                </div>
                                                <div class="form-floating mb-3">
                            ...
                            else if($_GET["action"] == 'edit')
                            {
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                <i class="fas fa-user-edit"></i> Modifier un fournisseur
                                            </div>
                                            <div class="card-body">
                                                <form method="post">
                                                    <div class="form-floating mb-3">
                        ...
                        ?>
                            ...
                            <ol class="breadcrumb mb-4">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Gestion des fournisseur</li>
                            </ol>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col col-md-6">
                                            <i class="fas fa-table me-1"></i> Gestion des fournisseur
                                        </div>
                                        <div class="col col-md-6" align="right">
                                            <a href="supplier.php?action=add&code=<?php echo $object->convert_data('add'); ?>" class="btn btn-success btn-sm">Ajouter un fournisseur</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
